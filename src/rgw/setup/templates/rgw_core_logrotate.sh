...
where:
-n            number of latest rgw core files to retain (Default count for core files is 5)
...
echo "max RGW core file to be collected: $core_files_max_count"
echo
